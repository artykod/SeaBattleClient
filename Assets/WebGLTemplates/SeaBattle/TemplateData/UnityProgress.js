function UnityProgress (dom) {
	...
	this.Update = function() {
		...
		this.progressFrame.style.top = this.dom.offsetTop + (this.dom.offsetHeight * 0.9) + 'px';
		...
		var borderSizeH = 2;
		var borderSizeV = 3;
		this.progressBar.style.top = (this.progressFrame.offsetTop + borderSizeV) + 'px';
		this.progressBar.style.left = (this.progressFrame.offsetLeft + borderSizeH) + 'px';
		this.progressBar.width = (progressFrameImg.width * Math.min(this.progress, 1) - borderSizeH*2);
		this.progressBar.height = (progressFrameImg.height - borderSizeV*2);
